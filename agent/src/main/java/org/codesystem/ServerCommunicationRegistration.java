...
public class ServerCommunicationRegistration {
    private final ServerCommunication serverCommunication = new ServerCommunication(new CryptoHandler(), AgentApplication.properties, AgentApplication.agentChecksum, new UpdateHandler(), new PackageHandler(AgentApplication.operatingSystem));
